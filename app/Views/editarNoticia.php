...
<body>
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url("processamento-adicionar/Evento/editar/{$event->id}") ?>" enctype="multipart/form-data">
            <div id="appCep">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nome" id="Nome" value="<?= $event->nome ?>" class="form-control">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" id="Email" value="<?= $event->email ?>" class="form-control">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="cep" type="text" id="cep" value="<?= $event->cep ?>" size="10" maxlength="9" class="form-control" onblur="pesquisacep(this.value);" /></label><br />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="rua" id="rua" value="<?= $event->rua ?>" class="form-control">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="bairro" value="<?= $event->bairro ?>" id="bairro" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="estado" id="uf" value="<?= $event->estado ?>" class="form-control" readonly>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="ibge" id="ibge" value="<?= $event->ibge ?>" class="form-control" readonly>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="ddd" id="ddd" value="<?= $event->ddd ?>" class="form-control" readonly>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="gia" id="gia" type="text" value="<?= $event->gia ?>" class="form-control" readonly>
            ...
            <div class="input-group">
                <div class="mb-3">
                    ...
                    <!-- Mostrar o nome atual -->
                    <small class="form-text text-muted">Imagem atual: <?= $event->imagem ?></small>
            ...
            <div class="input-group">
                <div class="mb-3">
                    ...
                    <!-- Mostrar o nome atual -->
                    <small class="form-text text-muted">Video atual: <?= $event->video ?></small>
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" style="height: 100px; width: 300px;" aria-label="With textarea" id="descricao" name="descricao"><?= $event->descricao ?></textarea>
